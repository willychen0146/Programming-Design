...
void find_best_choice_fast(int** list, int num_car_type, int num_stations, int* car_price_list, float** basic_driving_rate, float** decline_matrix, 
                      float decline_degree0, int* car_num_list, int* max_car_list, int* sum_car_x, int* sum_car_y, int total_car);
...
int main(){
    ...
    find_best_choice_fast(result, num_car_type, num_stations, car_price_list, basic_driving_rate, decline_matrix, decline_degree0, car_num_list, max_car_list, sum_car_x, sum_car_y, total_car);
